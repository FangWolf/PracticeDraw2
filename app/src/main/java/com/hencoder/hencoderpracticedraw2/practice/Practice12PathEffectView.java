...
public class Practice12PathEffectView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 第三处：DashPathEffect
        PathEffect pathEffect2 = new DashPathEffect(new float[]{20, 10, 5, 10}, 10);
        ...
        dashpath.rLineTo(-20, 15);
        dashpath.close();
        PathEffect pathEffect3 = new PathDashPathEffect(dashpath, 40, 0, PathDashPathEffect.Style.MORPH);
